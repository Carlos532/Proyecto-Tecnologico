...
?>
<?php include_once('layouts/encabezado.php');//AGREGA EL HEADER ?>
<!----------------------- INICIO CUERPO HTML ------------------------------>
<div class="row">
 <div class="col-md-12">
          ...
          <tbody>
            <?php foreach($all_groups as $a_group): ?>
              <tr>
               ...
               <td><span class="glyphicon glyphicon-user" aria-hidden="true"></span><?php echo remove_junk(ucwords($a_group['group_name']))?></td>
