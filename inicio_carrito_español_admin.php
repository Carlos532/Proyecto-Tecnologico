...
?>
    ...
    <div class="alert alert-success">
        <?php echo $mensaje; ?>
        <a href="mostrarCarrito.php" class="badge badge-success">Show car</a>
    </div>
    <?php } ?>
    <div class="row">
        <?php
        ...
        ?>
            ...
            <div class="card">
                ...
                >
                <div class="card-body">
                    <span>ID: <?php echo $producto['ID']; ?></span></br>
                ...
                <button class="btn btn-success" name="btnAccion" value="Agregar" type="submit">Añadir al carrito</button><br/>
                </form>
                </form>
                </form>
                </div>
