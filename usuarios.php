...
?>
<?php include_once('layouts/encabezado.php');//AGREGA HEADER ?>
<!--------------------------- INICIO CUERPO HTML -------------------------------------->
<div class="row">
   <div class="col-md-12">
      ...
      <table class="table table-bordered table-striped">
        ...
        <?php foreach($all_users as $a_user): ?>
          <tr>
           ...
           <td><span class="glyphicon glyphicon-user" aria-hidden="true"></span><?php echo remove_junk(ucwords($a_user['username']))?></td>
