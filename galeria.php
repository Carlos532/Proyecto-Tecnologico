        ...
        <div class="panel panel-default">
          <div class="panel-heading clearfix">
            ...
            <div class="pull-right">
              <form class="form-inline" action="galeria.php" method="POST" enctype="multipart/form-data">
          ...
          <div class="panel-body">
            <table class="table">
              <thead>
                ...
                <td class="text-center">
                  <a href="eliminar_galeria.php?id=<?php echo (int) $media_file['id'];?>" class="btn btn-danger btn-xs"  title="Eliminar">
